...
<xsl:param name="annotation.graphic.close" select="'http://docbook.github.com/latest/img/annot-close.png'"/>

<xsl:param name="annotation.graphic.open" select="'http://docbook.github.com/latest/img/annot-open.png'"/>
...
<xsl:param name="callout.graphics.path" select="'http://docbook.github.com/latest/img/'"/>
...
<xsl:param name="docbook.css" select="'http://docbook.github.com/latest/css/default.css'"/>

<xsl:param name="docbook.css.inline" select="0"/>

<xsl:param name="draft.mode" select="'maybe'"/>

<xsl:param name="draft.watermark.image" select="'http://docbook.github.com/latest/img/draft.svg'"/>
