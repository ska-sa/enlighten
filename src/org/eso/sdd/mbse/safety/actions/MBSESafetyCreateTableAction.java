...
public class MBSESafetyCreateTableAction extends DefaultBrowserAction {
	private PropertyManager properties = null;
	private static final boolean Debug = true;
	
	public MBSESafetyCreateTableAction() {
		super("", "SE2:RAMS Create Table", null, null);
	...
	public void actionPerformed(ActionEvent e) {
		...
		if (userObject instanceof Package) {
			...
			se.createRAMSTable(theProject, (Package)userObject, "RAMS");
			//se.listRAMSTable(theProject, (Package)userObject, "RAMS");
